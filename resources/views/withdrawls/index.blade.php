                            ...
                            <div class="card m-t-30 card-content">
                                <div class="row m-t-20">
                                    <div class="input-field col s12">
                                        <input id="min_withdrawl" value="{{ old('min_withdrawl') }}" name="min_withdrawl" type="text" class="validate" placeholder="e.g. $100" required>
                                ...
                                <div class="row m-t-20">
                                    <div class="input-field col s12">
                                        <input id="commission" value="{{ old('commission') }}" name="commission" type="text" class="validate" placeholder="e.g. 0.50 usd" required>
                    ...
                    <form method="POST" action="/withdrawls/generate/request">
                        ...
                        <div class="form-body">
                            <div class="card m-t-30 card-content">
                                <div>
                                    <div class="">
                                        <p class="font-bold " style="color: red;"># Please send the Payoneer withdrawal request to the following email ID
                                        - paidtoolnet@gmail.com <br>
                                        # Please send the Payoneer Request ID in the withdrawal request. <br>
                                        # Please follow the youtube link to know how to send payoneer payment request
                                        - <a href="https://www.youtube.com/watch?v=eLloPoLxB4g" target="_blank">https://www.youtube.com/watch?v=eLloPoLxB4g</a><br>
                                        # Please follow the youtube link to know how to withdraw your account balance to your paypal account
                                        - <a href="https://www.youtube.com/watch?v=BdTKqYVHHWo" target="_blank">https://www.youtube.com/watch?v=BdTKqYVHHWo</a> </p>
                                    </div>
                                    <div class="row m-t-20">
                                        <div class="input-field col s12">
                                            <input id="btc_address" value="{{ old('btc_address') }}" name="btc_address" type="text" class="validate" placeholder="Payoneer ID E.g.290410151 or Paypal : E.g: Johncartio@gmail.com or BTC E.g: 8563kjnKNJBFKJHF87JBIUHBJC" required>
                                           <label for="btc_address">Payoneer Request ID / Paypal Address / BTC Address</label>
                                            <!-- @error('btc_address')
                                                <span class="error" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
